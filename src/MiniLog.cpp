...
//=================================================================================
CMiniLog* CMiniLog::NewLC(RFs &aFs)
{
...
//=================================================================================
CMiniLog* CMiniLog::NewL(RFs &aFs)
{
    CMiniLog* self = CMiniLog::NewLC(aFs);
...
//=================================================================================
void CMiniLog::ConstructL(RFs &aFs)
{
    iFs = &aFs;
 
    if (iFile.Open(*iFs, KLogFile, EFileWrite) == KErrNotFound)
    {
        User::LeaveIfError(iFile.Create(*iFs, KLogFile, EFileWrite));
